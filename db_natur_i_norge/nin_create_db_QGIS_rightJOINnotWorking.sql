...
FROM nin_MinorTypeScaled 
    JOIN nin_MajorType 
        ON nin_MajorType._id = nin_MinorTypeScaled.minorType_id
    ...
    WHERE 
        ...
        -- [htgrk] is 'L'
        AND 
        mappingScale_id is '5000'
    -- organize by 
    ORDER BY nin_MinorTypeScaled._id
    -- ORDER BY nin_MajorType.`order`
;
